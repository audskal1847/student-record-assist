...
# ===== 0. 교육과정 핵심 개념 데이터베이스 (전과목 풀버전 확장) =====
CURRICULUM_DATA = {
    "국어군": {
        ...
        "실용 국어": ["직무 의사소통", "정보의 해석과 조직", "설득과 타협"],
        "심화 국어": ["논리적/비판적 사고", "학술적 글쓰기", "문제 해결적 의사소통"],
        "고전 읽기": ["고전의 가치", "고전의 수용", "고전과 지혜"]
    },
    "수학군": {
    ...
    "기타(생활/교양/예체능)": {
        ...
        "음악": ["음악의 이해", "음악의 표현", "음악과 삶"],
        "미술": ["미술의 이해", "미술의 표현", "미술과 삶"],
        "체육": ["체육의 가치", "건강 활동", "도전 활동", "경쟁 활동", "표현 활동"]
    }
}
...
with col_add1:
    ...
    if subject_group != "직접 입력" and subject in CURRICULUM_DATA[subject_group]:
        ...
        selected_concepts = st.multiselect("✅ 핵심 개념 자동 선택 (교육과정 기준)", concept_options, placeholder="클릭하여 핵심 개념을 추가하세요.")
